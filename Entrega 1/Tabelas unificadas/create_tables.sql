...
CREATE TABLE Monitora (
	...
	endereco VARCHAR2(255) NOT NULL,
	num_cancela NUMBER NOT NULL,
	inicio_monitoramento TIMESTAMP NOT NULL,
	fim_monitoramento TIMESTAMP NOT NULL,
	CONSTRAINT monitora_pk PRIMARY KEY (cpf_funcionario, endereco, num_cancela, inicio_monitoramento, fim_monitoramento),
